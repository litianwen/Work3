...
public final class CaptureActivity extends Activity implements
	...
	private void showResult(Result rawResult, URIResultHandler resultHandler,
		...
		setResult(RESULT_OK, new Intent().putExtra("result", displayContents));
		finish();
	}

	/**
	 * Put up our own UI for how to handle the decoded contents. ����ɨ����
	 * 
	 * @param rawResult
	 * @param resultHandler
	 * @param barcode
	...
	private void handleDecodeInternally(Result rawResult,
		...
		showResult(rawResult, resultHandler, barcode);// dialogչʾ��Ҫ��Ϣ
